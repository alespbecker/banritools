...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Exo+2:wght@600;700&family=IBM+Plex+Sans:wght@500;600&family=Source+Sans+3:wght@400;600&family=Poppins:wght@500&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
